...
namespace NorthwindProject.WebAPI.Controllers
{
    ...
    public class TerritoriesController : ApiBaseController<ITerritoryService, Territory, DtoTerritory>
    {
        public TerritoriesController(ITerritoryService service) : base(service)
        {
        }
    }
}